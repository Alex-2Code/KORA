...
Use the committed sample JSON or a JSON artifact generated by a prior run or report flow.
Next step after these basic flows: see `docs/benchmark-real-app.md` for a more realistic benchmark/report path.
